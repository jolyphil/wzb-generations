...
First, we observe **a decline in vote turnout** since the second world war in most western democracies. The decline in electoral participation is affecting all age groups, but even more so the youngest ones. In Germany, vote turnout for federal elections reached its peak in 1972, at 91.1% (in West Germany), and its low point in 2009, at 70,8%.

Second, the literature suggests there has been **a rise in extra-parliamentary forms of participation** since the 1960s. These include political actions like signing petitions, joining in boycotts, or taking part in demonstrations. These forms of political participation are not directly linked to the electoral process (although they might be). 

Scholars have been debating whether these trends are attributable to period or cohort effects.

Partisans of the period model argue that... [add arguments here]

Partisans of the cohort model argue that... [add arguments here]

Unfortunately, we might never be able to determine what from the period or cohort effects is driving the longterm trends in political participation. Separating age, period, and cohort (APC) effects poses a statistical problem... [introduce methodological considerations here]
