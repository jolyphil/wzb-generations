...
pct <- function(df, generation, action){
...
- In this paper:
    ...
    - We compare the repertoire of political participation of Millennials with those of Baby boomers and Xers in Germany using data of the European Social Survey collected from 2002 to 2017.
    - We show that Millennials are in general less active than the older generations, but this lower level of engagement might be an artifact of an age effect: Millennials are in fact more mobilized than Xers were at the same age.
...
ess %>%
  ...
  ggtitle("Political participation by generation and age") +
  labs(x = "Age at date of interview",
       y = "Predicted number of political activities",
       caption = "Source: European Social Survey (www.europeansocialsurvey.org)") +
  scale_color_discrete(name="",
                     labels = c("Millennials (1985-...)",
                                "Xers (1970-84)", 
                                "Boomers (1955-69)")) +
  theme(legend.position = "bottom")

ggsave("figures/number_activities_age_doi.png")
...
- They are usually a bit less active.
