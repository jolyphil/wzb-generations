...
First, we begin by exploring trends in voter turnout by age groups using data from the _Bundeswahlleiter_. 

Second, we examine the three generations' involvement in other forms of electoral and non-electoral political participation using data from eight biennial rounds of the European Social Survey (ESS) conducted between 2002 and 2017 [1].The ESS asked respondents whether they had engaged in various forms of political participation in the 12 months preceding each of the survey rounds. We compare the involvement of Millenials in two electoral activities: 1) contacting a politician or a government official and 2) working in a political party or action group. In addition, we look at participation in four nonelectoral activities: 1) working in another organisation or association, 2) signing a petition, 3) taking part in a lawful demonstration, and 4) boycotting certain products. 
