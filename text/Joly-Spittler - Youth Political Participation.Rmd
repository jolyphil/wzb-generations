...
To understand how Millennials get involve into politics, we need to take a step back and consider longterm dynamics in political participation.

According to the literature, two important trends have characterized the evolution of political participation in Western Europe over the last decades. 

First, we observe **a decline in vote turnout** since the Second World War. The decline in electoral participation is affecting all age groups, but even more so the youngest ones. In Germany, vote turnout for federal elections reached its peak in 1972, at 91.1% (in West Germany), and its low point in 2009, at 70.8%.

Second, the literature suggests there has been **a rise in extra-parliamentary forms of participation** since the 1960s. These include political actions such as signing petitions, joining in boycotts, or taking part in demonstrations. These forms of political participation are not directly linked to the electoral process (although they might be). 

Scholars have been debating whether these trends are attributable to period or cohort effects. 

Period effects could result from technological evolution, a growing acceptance by authorities for alternative forms of participation, a greater institutionalization of social movement organizations, and transformations of post-industrial economies characterized by an expanding service sector and the diffusion of post-secondary education. 

Cohort effects, in contrast, are not the product of a more favorable context for protest, but result from processes of political socialization through which young citizens have adopted a distinct set of attitudes and behavior: younger cohorts appear to be more postmaterialistic and they increasingly value self-expression, which leads them to embrace elite-challenging forms of participation.

Unfortunately, we might never be able to determine what from the period or cohort effects is driving the longterm trends in political participation. Indeed, separating age, period, and cohort (APC) effects poses a statistical problem... [introduce methodological considerations here]

In spite of these methodological diffulties, it is surprising that not more scholars have looked at the political participation of Millenials... [Move to gap here].
...
[Here, refer to the two longterm trends in political participation (lower vote turnout and rise in unconventional participation) and ask whether Millennials are following the trend or taking a distinct course.]
